...
class Checkpointer:
    ...
    def save_checkpoint(self,
                        ...
                        training_states: Dict[str, Any] = None,
                        step: int = -1) -> None:
        """
        ...
        if step > 0:
            ...
            print(f'saving {step} steps to {training_path}')
            ...
            training_path = os.path.join(self._serialization_dir,
                                         "training_state_latest.th")
            print(f'saving {epoch} epoch to {model_path}')
            hdfs_torch_save(model_state, model_path)
            print(f'saving {epoch} epoch to {training_path}')
            hdfs_torch_save(training_states, training_path)
